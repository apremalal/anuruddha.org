...
<?php get_header(); ?>
  <div class="container marketing">
      ...
      <div class="row featurette">
        ...
        <div class="clearfix"><a class="btn btn-primary" style="float:right" href="<?php echo get_site_url(); ?>/?p=205">Read More</a></div>
        </div>        
      </div>
      ...
      <div class="row featurette" style="margin-bottom:50px;">
        <div class="col-md-7">
          <h2 class="featurette-heading">Towards Context-Aware Just-in-Time Information: <span class="text-muted">Micro-A ctivity recognition of Everyday Objects.</span></h2><br/>
          <p class="lead">I did this research with my collegue Anuruddha Hettiarachchi. Through this research we discuss the end-to-end process of micro-activity recognition of augmented everyday-objects and presents a complete performance comparison of different classifiers. This paper is published in Eighth International Conference on Industrial and information Systems. </p>
        	<div class="clearfix"><a class="btn btn-primary" style="float:right" href="<?php echo get_site_url(); ?>/?p=53">Read More</a></div>
        </div>
        <div class="col-md-5">
      ...
      <div class="row featurette">
        ...
        <div class="col-md-7" style="margin-bottom:5%;">
          ...
          <div class="clearfix"><a class="btn btn-primary" style="float:right" href="<?php echo get_site_url(); ?>/?p=61">Read More</a></div>
        </div>
      </div>
